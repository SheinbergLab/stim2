...
static char const shader_source_frag7[] =
  ...
  "LOCALFUNC int pack16(int a, int b)\n"
  "{\n"
  "return bitfieldInsert(a, b, 16, 16);\n"
  "}\n"
  ...
  "imageStore_buf_i4(full_dc_buf, block_base + group, (v & 0xe000e000) | (p & 0x1fff1fff));\n"
  "}\n"
  ...
  "imageStore_buf_i2(sub_dc_buf, block_offs, (v & 0xe000e000) | (p & 0x1fff1fff));\n"
  "}\n"
  ...
  "}\n"
  "LOCALFUNC int util_min3(int a, int b, int c)\n"
  "{\n"
  "return min(min(a, b), c);\n"
  "}\n"
  "LOCALFUNC int util_max3(int a, int b, int c)\n"
  "{\n"
  "return max(max(a, b), c);\n"
  "}\n"
  "LOCALFUNC void dc_pred_delta(INOUT_PARA(int, dc), int pred)\n"
  "{\n"
  "dc = clamp(pred + dc, MININTRA, MAXINTRA);\n"
  "}\n"
  "LOCALFUNC void dc_pred_gradclamp(INOUT_PARA(int, dc), int n, int w, int nw)\n"
  "{\n"
  "int pred = clamp(n + w - nw, util_min3(n, w, nw), util_max3(n, w, nw));\n"
  "dc_pred_delta(dc, pred);\n"
  "}\n"
  ...
  "bool is_top = (U0(flags)[block_y >> 5].x & (1u << (block_y & 31))) != 0;\n"
  ...
  "{\n"
  "if (is_top)\n"
  "dc_pred_delta    ( dc0,  1024);\n"
  "else\n"
  "dc_pred_gradclamp( dc0,  N0, N0, N1);\n"
  "}\n"
  "else\n"
  "dc_pred_gradclamp( dc0, is_top ? W0 : N0, W0, is_top ? W1 : NW);\n"
...
static char const shader_source_frag12[] =
  ...
  "v_texcoords = st.x*constuv[0] + st.y*constuv[1] + constuv[2];\n"
  "gl_Position = vec4(st * pos_size.xy + pos_size.zw, 0.0, 1.0);\n"
  "}\n";
